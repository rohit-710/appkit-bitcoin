# Reown: AppKit - Bitcoin Example App
...
5. You will be able to see your example app which will allow you to connect your wallet and use the configured networks.

## Networks

Currently, this example app has the following blockchain networks configured:
- Bitcoin
...
- [Reown Blog](https://reown.com/blog)
